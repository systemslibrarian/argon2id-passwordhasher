...
- Pre-1.0 preview-bump mistakes (e.g. tagging `v0.4.0-preview.2`
...
```bash
gh release download v0.4.0-preview.2 \
...
```bash
gh attestation verify artifacts/Argon2id.PasswordHasher.0.4.0-preview.2.nupkg \
  --repo systemslibrarian/argon2id-passwordhasher
gh attestation verify artifacts/Argon2id.PasswordHasher.AspNetCore.0.4.0-preview.2.nupkg \
  --repo systemslibrarian/argon2id-passwordhasher
```
...
dotnet nuget push artifacts/Argon2id.PasswordHasher.0.4.0-preview.2.nupkg \
  --api-key "$KEY" \
  --source https://api.nuget.org/v3/index.json \
  --skip-duplicate

dotnet nuget push artifacts/Argon2id.PasswordHasher.AspNetCore.0.4.0-preview.2.nupkg \
  --api-key "$KEY" \
  --source https://api.nuget.org/v3/index.json \
  --skip-duplicate
...
```bash
gh release edit v0.4.0-preview.2 \
  --repo systemslibrarian/argon2id-passwordhasher \
  --notes "$(gh release view v0.4.0-preview.2 --json body -q .body \
